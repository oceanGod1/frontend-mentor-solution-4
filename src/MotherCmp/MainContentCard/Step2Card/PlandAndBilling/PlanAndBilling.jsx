...
export default function PlanAndBilling({ elemID, src, alt, title, monthly, yearly, isMonth, handleClick }) {
  return (
    <li id={elemID} className="plan-and-billing" onClick={handleClick}>
      ...
      <p className="yearly-bonus" style={{ display: isMonth ? "none" : "block" }}>
        2 months free
      </p>
    </li>
  );
